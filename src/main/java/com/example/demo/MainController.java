...
public class MainController {
	...
	public ModelAndView indexPost(ModelAndView mv, @RequestParam("calcVal") int calc) {
	...
	public ModelAndView shippingPost(ModelAndView mv, @RequestParam("Age") String age,
...
//	}
	...
	public ModelAndView indexPost(@ModelAttribute("formModel") @Validated UserData userData, BindingResult result,
			RedirectAttributes attributes, ModelAndView mv) {
	...
	public ModelAndView channelpost(@ModelAttribute("formModel") ChannelData ChannelData, ModelAndView mv) {
	...
	public ModelAndView day24post(@ModelAttribute("dayform") day24Data day24Data, ModelAndView mv) {
		drepository.saveAndFlush(day24Data);
		return new ModelAndView("redirect:/day24");
	}
	...
	public ModelAndView householdGet(@ModelAttribute("houseform") db_example db,
	...
	public ModelAndView householdPost(@ModelAttribute("houseform") @Validated db_example db_example,
			BindingResult result, RedirectAttributes attributes, @ModelAttribute("memberform") memberData memberData,
			ModelAndView mv) {
